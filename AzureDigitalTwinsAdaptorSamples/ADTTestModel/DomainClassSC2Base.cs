...
namespace ADTTestModel
{
    public partial class DomainClassSC2Base : DomainClassSC2
    {
        ...
        public static DomainClassSC2Base CreateInstance(InstanceRepository instanceRepository, Logger logger=null, IList<ChangedState> changedStates=null)
        {
            var newInstance = new DomainClassSC2Base(instanceRepository, logger);
        ...
        public DomainClassSC2Base(InstanceRepository instanceRepository, Logger logger)
        {
